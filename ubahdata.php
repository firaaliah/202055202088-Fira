...
include"koneksi.php";
$id= $_GET['id'];
$data= mysqli_query($koneksi,"SELECT * FROM 202055202088_ where nim='$id'");
...
if(isset($_POST['simpan'])){
	...
	$sql  = "UPDATE 202055202088_ SET nim='$nim', nama='$nama', alamat='$alamat', uang_jajan='$uang_jajan' WHERE nim='$nim'";
